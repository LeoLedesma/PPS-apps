...
export class LoginPage implements OnInit {
  ...
  completarCampos(id: number) {
      ...
      switch (id) {
        case 1:
          this.error = '';
          this.loginForm.controls['email'].setValue('mario@mail.com');
          this.loginForm.controls['password'].setValue('123456');
          break;
        case 2:
          this.error = '';
          this.loginForm.controls['email'].setValue('juan@mail.com');
          this.loginForm.controls['password'].setValue('123456');
          break;
        case 3:
          this.error = '';
          this.loginForm.controls['email'].setValue('leofledesma@gmail.com');
          this.loginForm.controls['password'].setValue('exeleo12');
          break;      
      }
  }
